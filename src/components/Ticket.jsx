...
function Ticket() {
  return (
    <div className=" font-Inconsolata tracking-wide flex flex-col gap-6 w-70 h-40 relative py-2 px-4">
      <svg
      ...
      <div>
        <Logo />
        <p className=" text-[#fff] ml-8 text-xs">Jan 31, 2025 / Yenagoa, Tx</p>
      </div>
      <div className=" flex items-center gap-2">
        <img src="../../public/48.jpeg" alt="Avatar" />
        <div>
          <h2 className=" text-[#fff]">Jonatan Kristof</h2>
          <div className=" flex">
            <img src={githubIcon} alt="Github icon" />
            <p className=" text-[#fff]">@jonatan</p>
          </div>
        </div>
      </div>
    </div>
